<template>
    <div class="food_container">
        <head-top goBack="true" :headTitle="headTitle"></head-top>
                ...
                <transition name="showlist" v-show="category">
                    <section v-show="sortBy == 'food'" class="category_container sort_detail_type">
                        <section class="category_left">
                            <ul>
                                <li v-for="(item,index) in category" :key="index" :class="{category_active:restaurant_category_id == item.id}" class="category_left_li" @click="selectCategoryName(item.id,index)">
                                    <section>
                                    ...
                                    <section>
                                        ...
                                        <svg v-if="" width="8" height="8" xmlns="http://www.w3.org/2000/svg" version="1.1" class="category_arrow" >
                        ...
                        <section class="category_right">
                            <ul>
                                <li v-for="(item,index) in categoryDetail" v-if="index" :key="index" class="category_right_li" :class="{category_right_choosed: restaurant_category_ids == item.id || (!restaurant_category_ids)&&index == 0}" @click="getCategoryIds(item.id,item.name)">
                                    <span>{{item.name}}</span>
