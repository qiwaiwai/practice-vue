                ...
                <section  class="food_container">
                            ...
                            <scroll ref="scroll">
                                <ul>
                                    <li v-for="(item,index) in menuList" :key="index" :class="{activity_menu: index == menuIndex}" class="menu_left_li" @click="chooseMenu(index)">
                                        <img src="" alt="">
                                        <span>{{item.name}}</span>
                                        <span v-if="categoryNum[index]&&item.type==1" class="category_num">{{categoryNum[index]}}</span>
                                    </li>
                                </ul>
                            </scroll>
                        </section>
                    ...
                    <section class="buy_cart_container">
                        ...
                        <section class="gotopay" :class="{gotopay_acitvity: minimumOrderAmount <= 0}">
                            ...
                            <router-link :to="{path:'/confirmOrder',query:{geohash, shopId}}" v-else class="gotopay_button_style">去结算</router-link>
                        </section>
                    </section>
...
export default {
    ...
    methods:{
        ...
        chooseMenu(index){
            this.$refs.scrollRight.scrollTo(0, -this.shopListTop[index], 400)
